...
## Project Structure
    ...
    ├── testapiautoteammem_113490  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_113490`
...
2. Clone this repo and `cd testapiautoteammem_113490`
